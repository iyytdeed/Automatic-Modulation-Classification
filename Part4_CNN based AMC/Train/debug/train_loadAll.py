...
x_data_mat_add = sio.loadmat('./dataset/train_data_45.mat')
x_data_complex_add = x_data_mat_add['train_data']
x_data_complex = np.concatenate((x_data_complex, x_data_complex_add), axis=0)
x_data_mat_add = sio.loadmat('./dataset/train_data_90.mat')
x_data_complex_add = x_data_mat_add['train_data']
x_data_complex = np.concatenate((x_data_complex, x_data_complex_add), axis=0)
...
y_data_mat_add = sio.loadmat('./dataset/train_label_45.mat')
y_data_add = y_data_mat_add['train_label']
y_data = np.concatenate((y_data, y_data_add), axis=0)
y_data_mat_add = sio.loadmat('./dataset/train_label_90.mat')
y_data_add = y_data_mat_add['train_label']
y_data = np.concatenate((y_data, y_data_add), axis=0)
