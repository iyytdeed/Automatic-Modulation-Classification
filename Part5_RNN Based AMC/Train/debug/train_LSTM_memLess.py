...
x_load_path = './dataset/train_data.mat'
y_load_path = './dataset/train_label.mat'
[x_train, y_train] = loadData(x_load_path, y_load_path)
...
with open('lstm_model_struct.json', 'w') as f:
    json.dump(model.to_json(), f)    
model.save_weights('lstm_model_struct.h5')
