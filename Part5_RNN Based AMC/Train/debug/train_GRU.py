...
from keras.layers import Input, Dense, LSTM, CuDNNLSTM, CuDNNGRU, Flatten, Dropout, BatchNormalization
...
ot = CuDNNGRU(16, return_sequences=False)(_in_)
#ot = Flatten()(ot)
...
model.summary()
with open('gru_model_struct.json', 'w') as f:
    json.dump(model.to_json(), f)    
model.save_weights('gru_model_struct.h5')
