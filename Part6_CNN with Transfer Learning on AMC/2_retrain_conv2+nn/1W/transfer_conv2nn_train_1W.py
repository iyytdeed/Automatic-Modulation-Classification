...
x_val = x_train[(x_train.shape[0]*99/100-1):-1,:]
y_val = y_train[(y_train.shape[0]*99/100-1):-1,:]
x_train = x_train[0:x_train.shape[0]*9/100,:]
y_train = y_train[0:y_train.shape[0]*9/100,:]
