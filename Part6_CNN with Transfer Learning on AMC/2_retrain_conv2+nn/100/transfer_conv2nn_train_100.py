...
x_val = x_train[(x_train.shape[0]*9999/10000-1):-1,:]
y_val = y_train[(y_train.shape[0]*9999/10000-1):-1,:]
x_train = x_train[0:x_train.shape[0]*9/10000,:]
y_train = y_train[0:y_train.shape[0]*9/10000,:]
...
ot = Conv2D(filters=16, kernel_size=(1,4), strides=1, padding='valid', use_bias=True, activation='relu', name='conv2d_2_train')(_in_)
ot = Flatten()(ot)
...
#scores = trained_model.evaluate(x_train_feature, y_train)
