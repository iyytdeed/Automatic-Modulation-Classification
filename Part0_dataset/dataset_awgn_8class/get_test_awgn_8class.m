...
for idx = 1:length(EsNo_array)
    ...
    for row = 1:NTest
        ...
        signal_data(row, L + 1) = 4;
        signal_data(row, L + 2) = EsNo;
    end
    for row = 1:NTest
        test_data((idx-1)*NClass*NTest+row+4*NTest, :) = signal_data(row, :);
    end
    ...
    for row = 1:NTest
        ...
        signal_data(row, L + 1) = 5;
        signal_data(row, L + 2) = EsNo;
    end
    for row = 1:NTest
        test_data((idx-1)*NClass*NTest+row+5*NTest, :) = signal_data(row, :);
    end
    ...
    for row = 1:NTest
        ...
        signal_data(row, L + 1) = 6;
        signal_data(row, L + 2) = EsNo;
    end
    for row = 1:NTest
        test_data((idx-1)*NClass*NTest+row+6*NTest, :) = signal_data(row, :);
    end
    ...
    for row = 1:NTest
        ...
        signal_data(row, L + 1) = 7;
        signal_data(row, L + 2) = EsNo;
    end
    for row = 1:NTest
        test_data((idx-1)*NClass*NTest+row+7*NTest, :) = signal_data(row, :);
    end
end
